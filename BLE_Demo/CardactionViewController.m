...
-(IBAction)Bluechongzhi:(id)sender{
    ...
    NSString* resPath = [[NSBundle mainBundle] pathForResource:@"BusInitInfo" ofType:@"plist"];
    NSDictionary* infos = [NSDictionary dictionaryWithContentsOfFile:resPath];
    NSString* str16response = infos[@"Card4442InfoData"];
